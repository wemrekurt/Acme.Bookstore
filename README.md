...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3e5c701b-ec12-4090-a102-784db3a78892
```

> `3e5c701b-ec12-4090-a102-784db3a78892` is the password of the certificate, you can change it to any password you want.
